...
The method is based on integrating the geoid equation $dr=-r\,\tan\psi\,d\phi$, where the small angle $\psi$ is modified by latitude-dependent rotation and the planet's multipolar gravity field. This type of calculation has long been applied to analyses of radio occultation experiments by spacecraft, including but not limited to
